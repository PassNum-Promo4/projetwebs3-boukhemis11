...
exports.savevoiture = function(req, res, next){
    ...
    const dt = req.body.cardate;
    const dt2 = req.body.cardate2;
    const typ = req.body.caraccount;
    const amt = req.body.caramt;
    const desc = req.body.cardesc;
	...
	if (carid) {
		//Edit voiture
		Voiture.findById(carid).exec(function(err, voiture){
